...
--------------------------------------------------------------------------------
-- 4. Patterns (default_implementation_id added after implementations table)
--------------------------------------------------------------------------------
...
--------------------------------------------------------------------------------
-- 5b. Add default_implementation_id FK to patterns
--------------------------------------------------------------------------------
ALTER TABLE patterns
    ADD COLUMN default_implementation_id BIGINT REFERENCES implementations(id) ON DELETE SET NULL;
