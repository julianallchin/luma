// One invocation owns one volume cell. Adjacent lanes shade adjacent points,
// reusing light records and coherent shadow-map texels through the GPU caches.
// All contributing lights are evaluated; there is no light-selection noise.
