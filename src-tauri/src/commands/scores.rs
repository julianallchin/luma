...
#[tauri::command]
pub async fn list_scores(db: State<'_, Db>, track_id: i64) -> Result<Vec<TrackScore>, String> {
...
#[tauri::command]
pub async fn update_score(db: State<'_, Db>, payload: UpdateScoreInput) -> Result<(), String> {
