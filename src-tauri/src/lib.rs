...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::authored_state::authored_state_read_workspace_file,
            commands::authored_state::authored_state_write_workspace_file,
            commands::authored_state::authored_state_edit_workspace_file,
