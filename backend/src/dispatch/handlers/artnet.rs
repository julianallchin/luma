//! Art-Net node discovery and persisted universe routing.
//! Discovery requires the physical-output service installed by the desktop host.
//! Headless callers can still edit routing without opening a socket.
