...
export type PatternEntrySummary = { durationSeconds: number, sampleRate: number, sampleCount: number, beatGrid: BeatGrid | null, };
...
export type PortType = "Intensity" | "Audio" | "BeatGrid";
