...
export type PatternEntrySummary = { durationSeconds: number, sampleRate: number, sampleCount: number, beatGrid: BeatGrid | null, crop: AudioCrop | null, };

export type PatternSummary = { id: number, name: string, description: string | null, createdAt: string, updatedAt: string, };

export type PlaybackStateSnapshot = { activeNodeId: string | null, isPlaying: boolean, currentTime: number, durationSeconds: number, };

export type PortDef = { id: string, name: string, portType: PortType, };

export type PortType = "Intensity" | "Audio" | "BeatGrid" | "Series" | "Color";

export type RunResult = { views: { [key in string]?: Array<number> }, seriesViews: { [key in string]?: Series }, melSpecs: { [key in string]?: MelSpec }, patternEntries: { [key in string]?: PatternEntrySummary }, colorViews: { [key in string]?: string }, };
