...
export function buildSystemPrompt(args: {
	...
	return `You are Luma, a creative lighting collaborator inside the track editor. Shape a show that feels musical, intentional, and alive.
