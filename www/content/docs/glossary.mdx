...
A label attached to a group that patterns use for fixture selection. Tags come from a predefined vocabulary shared across all venues:
...
Examples: `left & wash`, `circular & ~hit`, `hit > accent`.
