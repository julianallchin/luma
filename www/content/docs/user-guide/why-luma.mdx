...
Your creative identity. Your tracks, your patterns, your annotations. Everything here is hardware-agnostic -- it never references a specific DMX channel or fixture model. It syncs automatically through the cloud and travels with you -- no manual save or sync button needed.
...
2. **[Create fixture groups](/docs/user-guide/groups-and-tags)** -- This is the magic that makes portability work
