...
<NodeGraph
  nodes={[
    ...
    { id: "apply", label: "Apply Color", category: "output", x: 600, y: 40, inputs: ["Signal"] },
  ]}
  edges={[
...
5. `apply_color` writes the color signal to the fixtures targeted by the pattern's Selection argument.
